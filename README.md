About foundry-platform-sdk-feedstock
====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/foundry-platform-sdk-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/foundry-platform-sdk-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add foundry-platform-sdk
# for installing globally
pixi global install foundry-platform-sdk
```
...
It is possible to list all of the versions of `foundry-platform-sdk` available on your platform:
...
```
pixi search foundry-platform-sdk --channel conda-forge
```
